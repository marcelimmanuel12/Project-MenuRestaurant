...
!function(t) {
    ...
    var t, r = V, i = {}, e = i.toString, h = /^([\-+])=\s*(\d+\.?\d*)/, a = [{
    ...
    function m(s) {
        ...
        o.length ? ("0,0,0,0" === o.join() && r.extend(o, I.transparent),
        n) : I[s]
    }
    function n(t, e, i) {
    ...
    (c.fn = r.extend(c.prototype, {
        parse: function(n, t, e, i) {
            if (void 0 === n)
                ...
                this;
            (n.jquery || n.nodeType) && (n = r(n).css(t),
            t = void 0);
            var o = this
              , s = f(n)
              , a = this._rgba = [];
            ...
            s = "array"),
            "string" === s ? this.parse(m(n) || I._default) : "array" === s ? (p(u.rgba.props, function(t, e) {
                a[e.idx] = g(n[e.idx], e)
            }),
            ...
            : function(t, i) {
                ...
                o[s] && r.inArray(null, o[s].slice(0, 3)) < 0 && (null == o[s][3] && (o[s][3] = 1),
    ...
    p(u, function(l, t) {
        ...
        p(e, function(a, r) {
            c.fn[a] || (c.fn[a] = function(t) {
                var e, i = f(t), s = "alpha" === a ? this._hsla ? "hsla" : "rgba" : l, n = this[s](), o = n[r.idx];
                return "undefined" === i ? o : ("function" === i && (i = f(t = t.call(this, o))),
                null == t && r.empty ? this : ("string" === i && (e = h.exec(t)) && (t = o + parseFloat(e[2]) * ("+" === e[1] ? 1 : -1)),
                n[r.idx] = t,
                this[s](n)))
            }
            )
    ...
    (c.hook = function(t) {
        ...
        p(t, function(t, o) {
            ...
            r.fx.step[o] = function(t) {
                t.colorInit || (t.start = c(t.elem, o),
                t.end = c(t.end),
                t.colorInit = !0),
    ...
    var o, _, v, b, y, w, x, k, C, D, I = r.Color.names = {
        ...
        _default: "#ffffff"
    }, T = "ui-effects-", P = "ui-effects-style", M = "ui-effects-animated";
    function S(t) {
        ...
        return this.queue(function() {
            ...
            e = e.map(function() {
                ...
                this.diff = function(t, e) {
                    ...
                    for (i in e)
                        s = e[i],
                        t[i] !== s && (y[i] || !V.fx.step[i] && isNaN(parseFloat(s)) || (n[i] = s));
                    return n
                }(this.start, this.end),
                this
            }),
    ...
    V.fn.extend({
        ...
        removeClass: (_ = V.fn.removeClass,
        function(t, e, i, s) {
        ...
        toggleClass: (o = V.fn.toggleClass,
        function(t, e, i, s, n) {
    ...
    V.fn.extend({
        ...
        toggle: (x = V.fn.toggle,
        function(t) {
            if (z(t) || "boolean" == typeof t)
    ...
    V.escapeSelector || (O = /([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g,
    N = function(t, e) {
    ...
    V.fn.position = function(u) {
        ...
        V.each(["my", "at"], function() {
            ...
            (i = 1 === i.length ? L.test(i[0]) ? i.concat(["center"]) : R.test(i[0]) ? ["center"].concat(i) : ["center", "center"] : i)[0] = L.test(i[0]) ? i[0] : "center",
        ...
        m.top += d[1],
        this.each(function() {
            var i, t, a = V(this), r = a.outerWidth(), l = a.outerHeight(), e = U(this, "marginLeft"), s = U(this, "marginTop"), n = r + e + U(this, "marginRight") + b.width, o = l + s + U(this, "marginBottom") + b.height, h = V.extend({}, m), c = K(w.my, a.outerWidth(), a.outerHeight());
            ...
            u.using && (t = function(t) {
                ...
                W(F(e), F(i)) > W(F(s), F(n)) ? o.important = "horizontal" : o.important = "vertical",
    ...
    var $, G, Q = 0, J = Array.prototype.hasOwnProperty, Z = Array.prototype.slice;
    V.cleanData = (G = V.cleanData,
    function(t) {
    ...
    V.widget.extend = function(t) {
        for (var e, i, s = Z.call(arguments, 1), n = 0, o = s.length; n < o; n++)
            for (e in s[n])
                i = s[n][e],
                J.call(s[n], e) && void 0 !== i && (V.isPlainObject(i) ? t[e] = V.isPlainObject(t[e]) ? V.widget.extend({}, t[e], i) : V.widget.extend({}, i) : t[e] = i);
        return t
    }
    ,
